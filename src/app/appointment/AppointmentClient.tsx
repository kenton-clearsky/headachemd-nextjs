    ...
    <main style={{ minHeight: '100vh', background: '#F4F8E9' }}>
      <Container sx={{ maxWidth: 'lg', py: 3 }}>
        ...
        <Typography variant="body1" sx={{ mb: 3, color: '#47542B' }}>
          Please complete the form and our team will contact you as soon as possible.
        </Typography>
            ...
            <Card sx={{ border: '1px solid #dbe3c9' }}>
              <CardContent>
                ...
                <Box component="form" method="POST" action="https://formsubmit.co/5e623f96d7937c204ee6500c187f69b5">
                  <input type="hidden" name="_subject" value="New Appointment Request - headacheMD.org" />
                  <input type="hidden" name="_next" value="https://headachemd.org/" />
                  <input type="hidden" name="_captcha" value="false" />
                  <input type="hidden" name="_template" value="table" />
                  <input type="hidden" name="_autoresponse" value="Thank you for your appointment request. Our team will contact you shortly to confirm details." />
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField select fullWidth label="Reason for Visit" name="subject" required defaultValue="">
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField fullWidth type="date" label="Preferred Date" name="preferred_date" InputLabelProps={{ shrink: true }} />
                    </Grid>
                    <Grid item xs={12}>
                      <TextField fullWidth label="Message" name="message" multiline minRows={6} required placeholder="Please describe your symptoms or questions..." />
                    </Grid>
                    <Grid item xs={12}>
                      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                        ...
                        <Button href="/contact" variant="outlined" sx={{ borderColor: '#a5c422', color: '#47542B' }}>
                          Contact Info
                        </Button>
                      </Stack>
                    </Grid>
          ...
          <Grid item xs={12} md={4}>
            <Stack spacing={3}>
              ...
              <Card sx={{ border: '1px solid #dbe3c9', overflow: 'hidden' }}>
                <Box component="img" src="/legacy/images/appointment-image.jpg" alt="Appointment" sx={{ width: '100%', display: 'block' }} />
              </Card>
            </Stack>
          </Grid>
        </Grid>
